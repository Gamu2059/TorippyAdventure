 ...
 * */
	...
	typedef struct{
		...
		char wallKickFlag,wallHeadFlag,turnFlag;
		char fallFlag;
		float fallTime;
		float v0,vA,vX;
		float a0,aA,aX;
 ...
 * ・turnFlagはキャラクタがその場で向きを変えた状態かどうかを管理します。
